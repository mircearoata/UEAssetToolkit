...
public:
    ...
    TMap<FTopLevelAssetPath, TWeakObjectPtr<UAssetTypeSerializer>> Serializers;
...
UAssetTypeSerializer* UAssetTypeSerializer::FindSerializerForAssetClass(const FTopLevelAssetPath AssetClass) {
